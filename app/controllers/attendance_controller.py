...
from app.services.attendance_service import get_student_name_id,get_today_attendance,get_students_attendance,register_students_attendance,students_attendance_average
...
@attendance_bp.route("/attendance_report", methods=["POST"])
